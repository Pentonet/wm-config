...
function docker_backwards_compat_transport_service()
{
    ...
    WM_SERVICES_GATEWAY_ID=${WM_GW_ID}
    WM_SERVICES_GATEWAY_MODEL=${WM_GW_MODEL}
    WM_SERVICES_GATEWAY_VERSION=${WM_GW_VERSION}

    WM_SERVICES_HOST=${WM_SERVICES_MQTT_HOSTNAME}
    WM_SERVICES_MQTT_USER=${WM_SERVICES_MQTT_USERNAME}
    ...
    WM_SERVICES_ALLOW_UNSECURE=${WM_SERVICES_MQTT_ALLOW_UNSECURE}
    WM_SERVICES_CERTIFICATE_CHAIN=${WM_SERVICES_MQTT_CERTIFICATE_CHAIN}

    WM_SERVICES_GATEWAY_IGNORED_ENDPOINTS_FILTER=${WM_GW_IGNORED_ENDPOINTS_FILTER}
    WM_SERVICES_GATEWAY_WHITENED_ENDPOINTS_FILTER=${WM_GW_WHITENED_ENDPOINTS_FILTER}
}
...
function docker_backwards_compat_sink_service()
{
    ...
    WM_SINK_UART_PORT=${WM_GW_SINK_UART_PORT}
    WM_SINK_UART_BITRATE=${WM_GW_SINK_BITRATE_CONFIGURATION}
    WM_SINK_ID=${WM_GW_SINK_ID}
}
