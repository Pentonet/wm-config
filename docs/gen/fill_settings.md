...
| _WM-CONFIG updater_                | ---                                                                                                                                                                           |
| ---                                | ---                                                                                                                                                                           |
| ##WM_CFG_UPDATE                    | **DEPRECATE?** When _true_ the wm-config executable will be updated and the device will reboot (##WM_CFG_UPDATE_DEFAULT)                                                      |
| ##WM_CFG_FRAMEWORK_UPDATE             | **DEPRECATE?** When _true_ the wm-config will pull a settings image based on the WM_CFG_UPDATER_IMAGE and WM_CFG_UPDATER_VERSION (##WM_CFG_FRAMEWORK_UPDATE_DEFAULT)             |
...
| ##WM_SERVICES_CERTIFICATE_CHAIN                 | The container path where to find the root ca certificates (##WM_SERVICES_CERTIFICATE_CHAIN_DEFAULT)                                                            |
| ---                                             | ---                                                                                                                                                            |
...
| ##WM_GW_SINK_UART_PORT                        | **DEPRECATE?** The port where a Wirepas sink can be found from (##WM_GW_SINK_UART_PORT_DEFAULT)                                                              |
| ##WM_GW_SINK_ID                               | **DEPRECATE?** The pseudo id of the sink served by the sink service (##WM_GW_SINK_ID_DEFAULT)                                                                |
| ##WM_HOST_TTY_SYMLINK                                | **DEPRECATE?** The serial alias to associate with a Wirepas complaint device attached to the host (##WM_HOST_TTY_SYMLINK_DEFAULT)                                   |
...
| ##WM_SYSTEMD_UPDATER_ENABLE            | When _true_ the systemd job will be enabled and started (##WM_SYSTEMD_UPDATER_ENABLE_DEFAULT) |
| ##WM_SYSTEMD_UPDATER_DISABLE           | When _true_ the systemd job will be disabled (##WM_SYSTEMD_UPDATER_DISABLE_DEFAULT)           |
| ---                                        | ---                                                                                               |
